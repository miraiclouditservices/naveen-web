        ...
        <div className="modal-content border-0 rounded-4 shadow-lg overflow-hidden bg-white">
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body p-4" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
              ...
              <h6 className="fw-bold text-primary mb-3" style={{ color: 'var(--dark-section)' }}>Company Information</h6>
              ...
              <h6 className="fw-bold text-primary mb-3" style={{ color: 'var(--dark-section)' }}>Contact & Status</h6>
