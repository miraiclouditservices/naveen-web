        ...
        <div className="modal-content border-0 rounded-4 shadow-lg overflow-hidden bg-white">
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body p-4" style={{ maxHeight: '70vh', overflowY: 'auto' }}>
              ...
              <h6 className="fw-bold text-primary mb-3" style={{ color: 'var(--dark-section)' }}>Unit Information</h6>
              ...
              <h6 className="fw-bold text-primary mb-3" style={{ color: 'var(--dark-section)' }}>Owner Details</h6>
              <div className="row g-3 mb-4">
                <div className="col-md-6">
              ...
              <h6 className="fw-bold text-primary mb-3" style={{ color: 'var(--dark-section)' }}>Lease Holder Details & Remarks</h6>
