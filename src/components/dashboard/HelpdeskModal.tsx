...
export default function HelpdeskModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.attachment) dataToSave.attachment = formData.attachment;
      if (formData.locationArea) dataToSave.locationArea = formData.locationArea;
      if (formData.unit) dataToSave.unit = formData.unit;
      if (propId) dataToSave.property = propId;
      if (floorId) dataToSave.floor = floorId;
